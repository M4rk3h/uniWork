...
## Import Datasets
s3e1  <- read.csv("s3e1.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e2  <- read.csv("s3e2.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e3  <- read.csv("s3e3.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e4  <- read.csv("s3e4.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e5  <- read.csv("s3e5.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e6  <- read.csv("s3e6.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e7  <- read.csv("s3e7.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e8  <- read.csv("s3e8.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e9  <- read.csv("s3e9.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e10 <- read.csv("s3e10.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e11 <- read.csv("s3e11.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e12 <- read.csv("s3e12.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e13 <- read.csv("s3e13.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e14 <- read.csv("s3e14.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e15 <- read.csv("s3e15.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e16 <- read.csv("s3e16.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e17 <- read.csv("s3e17.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)
s3e18 <- read.csv("s3e18.txt", sep=",", header=TRUE, stringsAsFactors = FALSE)

## create a tibble with the Episode ([,1]) & Words ([,2])
tibs3e1 <- tibble(Episode = s1e1[,1], Words = s1e1[,2])
tibs3e2 <- tibble(Episode = s1e2[,1], Words = s1e2[,2])
tibs3e3 <- tibble(Episode = s1e3[,1], Words = s1e3[,2])
tibs3e4 <- tibble(Episode = s1e4[,1], Words = s1e4[,2])
tibs3e5 <- tibble(Episode = s1e5[,1], Words = s1e5[,2])
tibs3e6 <- tibble(Episode = s1e6[,1], Words = s1e6[,2])
tibs3e7 <- tibble(Episode = s1e7[,1], Words = s1e7[,2])
tibs3e8 <- tibble(Episode = s1e8[,1], Words = s1e8[,2])
